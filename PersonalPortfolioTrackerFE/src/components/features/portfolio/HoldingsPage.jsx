                  ...
                  <div>
                    ...
                    {detailHolding.targetBuy ? (
                      <span className="font-bold text-blue-600 text-[15px] flex flex-wrap items-center gap-1.5">
                        ...
                        <span className={`text-[10px] px-1.5 py-0.5 rounded border ${detailHolding.investmentCost > 0 && detailHolding.targetBuy >= detailHolding.investmentCost ? "bg-emerald-50 text-emerald-600 border-emerald-100" : "bg-blue-50 text-blue-600 border-blue-100"}`}>
                          {formatPercent(detailHolding.investmentCost > 0 ? (detailHolding.targetBuy - detailHolding.investmentCost) / detailHolding.investmentCost : 0)}
                        </span>
                      </span>
                  ...
                  <div>
                    ...
                    {detailHolding.targetSell ? (
                      <span className="font-bold text-orange-600 text-[15px] flex flex-wrap items-center gap-1.5">
                        ...
                        <span className={`text-[10px] px-1.5 py-0.5 rounded border ${detailHolding.investmentCost > 0 && detailHolding.targetSell >= detailHolding.investmentCost ? "bg-emerald-50 text-emerald-600 border-emerald-100" : "bg-orange-50 text-orange-600 border-orange-100"}`}>
                          {formatPercent(detailHolding.investmentCost > 0 ? (detailHolding.targetSell - detailHolding.investmentCost) / detailHolding.investmentCost : 0)}
                        </span>
                      </span>
                    ) : <span className="font-bold text-gray-500 text-[15px]">-</span>}
                  </div>
