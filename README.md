...
*(Quản lý tài sản cá nhân toàn diện, kiểm soát dòng tiền từ tiền mặt, ngân hàng, tín dụng, tiết kiệm đến chứng khoán và tiền điện tử.)*
...
* **📊 Intuitive Dashboard (Dashboard trực quan):**
  Get an instant snapshot of your Portfolio Value, Cash Balance, and P&L with clear asset allocation charts. 
...
* **🛡️ Secure & Private (Bảo mật & Riêng tư):**
  Your financial data remains strictly confidential with modern security standards.
...
Create accounts that mirror your real-world assets (e.g., Securities Brokerage, Crypto Wallets, Cash). Categorize correctly for accurate performance tracking.
*(Tạo các "Account" tương ứng với ví thực tế. Lưu ý phân loại đúng loại tài khoản.)*

### Step 2: Trading & Analytics (Giao dịch & Mục tiêu)
* **BUY:** Funds are automatically deducted from Available Cash and updated into Invested Balance.
* **Target & Notes:** Use the Holdings page to set target prices. Use the Note feature to upload technical analysis charts.
*(Lệnh Mua tự động trừ tiền Cash. Đặt Target và dùng Note lưu ảnh phân tích kỹ thuật.)*

### Step 3: Importing Existing Holdings (Nhập dữ liệu cũ)
If you already hold assets, follow these strict steps to set up your cost basis:
